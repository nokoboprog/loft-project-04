...
<div class="main-wrapper">
    <header class="main-header">
        <div class="logotype-container"><a href="{{ route('index') }}" class="logotype-link"><img src="/img/logo.png"
                                                                                                  alt="Логотип"></a>
        </div>
        <nav class="main-navigation">
            <ul class="nav-list">
                ...
                @auth
                    <li class="nav-list__item"><a href="{{ route('orders.index') }}" class="nav-list__item__link">Мои
                            заказы</a></li>
                @endauth
            </ul>
        </nav>
            ...
            <div class="payment-container">
                <div class="payment-basket__status">
                    ...
                    <div class="payment-basket__status__basket"><span
                            class="payment-basket__status__basket-value">@yield('orders_count')</span><span
                            class="payment-basket__status__basket-value-descr">заказов</span></div>
                </div>
            </div>
    ...
    <div class="middle">
        ...
        <div class="main-content">
            <div class="content-top">
                <div class="content-top__text">Купить игры недорого, без регистрации и смс, с торрента, получить компакт
                    диск,
                    ...
                    <div class="random-product-container__content">
                        <div class="item-product">
                            <div class="item-product__title-product"><a
                                    href="{{route('products.index', ['id' => $randomProduct->id])}}"
                            ...
                            <div class="item-product__thumbnail"><a
                                    ...
                                    class="item-product__thumbnail__link"><img
                                        src="/upload/products/{{$randomProduct->img}}" alt="Preview-image"
                                        class="item-product__thumbnail__link__img"></a></div>
                            <div class="item-product__description">
                                <div class="item-product__description__products-price"><span class="products-price">{{ floatval($randomProduct->price) }} руб</span>
                                </div>
                                <div class="item-product__description__btn-block">
                                    @guest
                                        <a title="Для того чтобы купить, войдите" href="{{ route('login') }}"
                                           class="btn btn-blue">Купить</a>
                                    @else
                                        <a href="{{ route('orders.store', ['product_id' => $randomProduct->id]) }}"
                                           class="btn btn-blue addToCart">Купить</a>
                                    @endguest
                                </div>
                            </div>
                        </div>
